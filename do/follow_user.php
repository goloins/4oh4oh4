...
*/
// do/follow_user.php - follows a user.
...
if ((int)$target['id'] === (int)$_SESSION['user_id']) {
    set_notif_banner("You can't follow yourself.");
    redirect('/user/' . $username);
}

follow_user($_SESSION['user_id'], $target['id']);
